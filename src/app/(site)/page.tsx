  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="md:mt-[-90px] sm:w-full w-[750px] flex justify-center items-center
          ...
          animate-slide"
            >
              {CLIENTS.map((client) => (
                <div
                  key={client.alt}
                  className="relative w-[200px] m-20 shrink-0
              flex items-center"
                >
                  <Image
                    src={client.logo}
      ...
      <section className="px-4 sm:px-6 flex justify-center items-center flex-col relative">
        ...
        />
        <div
          className="mt-10 max-w-[450px] flex justify-center items-center 
          relative sm:ml-0 rounded-2xl border-8 border-washed-purple-300 border-opacity-10"
        >
            ...
            >
              {USERS.map((testimonial, index) => (
                <CustomCard
                  ...
                  className="w-[500px] shrink-0s rounded-xl dark:bg-gradient-to-t
